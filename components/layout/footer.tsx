...
export default function Footer() {
  ...
  const contactInfo = [
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '01273 453109', link: 'tel:01273453109' },
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'info@stmaryshousedental.co.uk', link: 'mailto:info@stmaryshousedental.co.uk' },
    { icon: <MapPin className="w-5 h-5" />, label: 'Address', value: "1 St Mary's House, Shoreham-by-Sea, West Sussex BN43 5ZA", link: 'https://maps.google.com/?q=Shoreham-by-Sea+Dental+Practice' },
  ];
  ...
  return (
    <footer
      className="relative text-white overflow-hidden bg-slate-900 dark:bg-[#0b1220]"
      style={{
    ...
    >
        ...
        {[...Array(15)].map((_, i) => (
          <motion.div
            ...
            className={`absolute w-2 h-2 rounded-full ${
              i % 3 === 0 ? 'bg-pink-400/30' : i % 3 === 1 ? 'bg-teal-400/30' : 'bg-yellow-400/30'
            }`}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-300 leading-relaxed" style={{ fontFamily: 'Lora, serif' }}>
          ...
          {/* Contact Information */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-6" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Contact Information
            </h4>
            ...
            <div className="space-y-3">
              {openingHours.map((schedule, index) => (
                <div key={index} className="flex justify-between items-center">
                  <span className="text-slate-300" style={{ fontFamily: 'Lora, serif' }}>
                    {schedule.day}
                  </span>
        ...
        <div className="border-t border-white/10 pt-8 mb-8">
          <h4 className="text-lg font-semibold text-white mb-6 text-center" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            Our Treatments
          </h4>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {treatments.map((treatment) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className="text-sm text-slate-300 hover:text-white" style={{ fontFamily: 'Lora, serif' }}>
                  {treatment.name}
                </span>
              </motion.a>
            ))}
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-slate-400 text-sm" style={{ fontFamily: 'Lora, serif' }}>
            © {currentYear} St Mary&apos;s House Dental Care. All rights reserved.
          </div>
          <div className="flex gap-6 text-sm">
            <a href="/privacy-policy" className="text-slate-400 hover:text-white transition-colors duration-200" style={{ fontFamily: 'Lora, serif' }}>
              Privacy Policy
            </a>
            <a href="/terms-conditions" className="text-slate-400 hover:text-white transition-colors duration-200" style={{ fontFamily: 'Lora, serif' }}>
              Terms &amp; Conditions
            </a>
            <a href="/cookie-policy" className="text-slate-400 hover:text-white transition-colors duration-200" style={{ fontFamily: 'Lora, serif' }}>
              Cookie Policy
            </a>
          </div>
        </div>
        ...
        <motion.div
          ...
          animate={{ boxShadow: ['0 0 0 0 rgba(220,38,38,0.4)', '0 0 0 10px rgba(220,38,38,0)', '0 0 0 0 rgba(220,38,38,0)'] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          <p className="text-white font-semibold" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            Dental Emergency? Call us 24/7:
            <a href="tel:01273453109" className="ml-2 underline hover:no-underline">
              01273 453109
            </a>
          </p>
        </motion.div>
